...
CREATE TABLE IF NOT EXISTS `mydb`.`Numero Celular` (
  ...
  INDEX `fk_Numero Telefone_Pessoas_idx` (`Pessoas_idPessoas` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`nome` (
  ...
  PRIMARY KEY (`idNome`),
  INDEX `fk_nome_Pessoas1_idx` (`Pessoas_idPessoas` ASC) VISIBLE,
  INDEX `fk_nome_Autor1_idx` (`Autor_idAutor` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Reserva` (
  ...
  INDEX `fk_Reserva_Usuario1_idx` (`Usuario_Pessoas_idPessoas` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Emprestimo` (
  ...
  INDEX `fk_Emprestimo_Usuario1_idx` (`Usuario_Pessoas_idPessoas` ASC) VISIBLE,
  INDEX `fk_Emprestimo_Reserva1_idx` (`Reserva_idReserva` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Bibliotecário` (
  ...
  PRIMARY KEY (`Pessoas_idPessoas`),
  INDEX `fk_Bibliotecário_Emprestimo1_idx` (`Emprestimo_idEmprestimo` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Titulos Virtuais` (
  `ISBN` INT NOT NULL,
  `Tamanho do arquivo` FLOAT NOT NULL,
  `Edicao` INT NOT NULL,
  `Publicacao` DATE NOT NULL,
  `Tempo de Duracao` FLOAT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Titulos Virtuais_has_Usuario` (
  ...
  INDEX `fk_Titulos Virtuais_has_Usuario_Usuario1_idx` (`Usuario_Pessoas_idPessoas` ASC) VISIBLE,
  INDEX `fk_Titulos Virtuais_has_Usuario_Titulos Virtuais1_idx` (`Titulos Virtuais_ISBN` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Autor_has_Titulos Virtuais` (
  ...
  INDEX `fk_Autor_has_Titulos Virtuais_Titulos Virtuais1_idx` (`Titulos Virtuais_ISBN` ASC) VISIBLE,
  INDEX `fk_Autor_has_Titulos Virtuais_Autor1_idx` (`Autor_idAutor` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Titulos fisicos` (
  ...
  PRIMARY KEY (`ISBN`),
  INDEX `fk_Titulos fisicos_Reserva1_idx` (`Reserva_idReserva` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Exemplares` (
  ...
  `Status Exemplar` TINYINT NOT NULL,
  `ISBN` INT NOT NULL,
  PRIMARY KEY (`Numero Exemplares`, `ISBN`),
  INDEX `fk_Exemplares_Titulos fisicos1_idx` (`ISBN` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Editora` (
  ...
  INDEX `fk_Editora_Titulos fisicos1_idx` (`Titulos fisicos_ISBN` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Contém` (
  ...
  INDEX `fk_Emprestimo_has_Exemplares_Exemplares1_idx` (`Exemplares_Numero Exemplares` ASC) VISIBLE,
  INDEX `fk_Emprestimo_has_Exemplares_Emprestimo1_idx` (`Emprestimo_idEmprestimo` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Devolucao` (
  ...
  INDEX `fk_Devolucao_Bibliotecário1_idx` (`Bibliotecário_Pessoas_idPessoas` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Emprestimo_has_Devolucao` (
  ...
  INDEX `fk_Emprestimo_has_Devolucao_Devolucao1_idx` (`Devolucao_idDevolucao` ASC) VISIBLE,
  INDEX `fk_Emprestimo_has_Devolucao_Emprestimo1_idx` (`Emprestimo_idEmprestimo` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Multa` (
  ...
  INDEX `fk_Multa_Devolucao1_idx` (`Devolucao_idDevolucao` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Categorias` (
  ...
  INDEX `fk_Categorias_Sessao1_idx` (`Sessao_idSessao` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Exemplares_has_Categorias` (
  ...
  INDEX `fk_Exemplares_has_Categorias_Categorias1_idx` (`Categorias_idCategorias` ASC) VISIBLE,
  INDEX `fk_Exemplares_has_Categorias_Exemplares1_idx` (`Exemplares_Numero Exemplares` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Autor_has_Titulos fisicos` (
  ...
  INDEX `fk_Autor_has_Titulos fisicos_Titulos fisicos1_idx` (`Titulos fisicos_ISBN` ASC) VISIBLE,
  INDEX `fk_Autor_has_Titulos fisicos_Autor1_idx` (`Autor_idAutor` ASC) VISIBLE,
